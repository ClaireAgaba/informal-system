...
urlpatterns = [
    ...
    path('person/<str:person_id>/registration/<int:registration_id>/update/', views.update_registration, name='dit_legacy_update_registration'),
    # Exam Results CRUD
    path('person/<str:person_id>/exam-result/add/', views.add_exam_result, name='dit_legacy_add_exam_result'),
    path('person/<str:person_id>/exam-result/<int:result_id>/update/', views.update_exam_result, name='dit_legacy_update_exam_result'),
