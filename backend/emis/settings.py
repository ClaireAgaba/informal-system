...
INSTALLED_APPS = [
    ...
    'assessment_centers.apps.AssessmentCentersConfig',
    'assessment_series.apps.AssessmentSeriesConfig',
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'emis.pagination.FlexiblePagination',
    'PAGE_SIZE': 20,
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='UVTAB EMIS <eimsuvtab@gmail.com>')
